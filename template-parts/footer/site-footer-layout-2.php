...
?>
<div class="container ti-footer-layout-1 ti-footer-layout">
    <div class="ti-footer-layout-1-inside ti-footer-layout-inside">
        <div class="ti-footer-layout-1--top">
            <div class="row">
                <!------ Column of Logo & Socials -->
                <div class="col-lg-4 order-2 order-lg-1">
                    <div class="ti-footer-layout-1--brand-area ti-footer-layout--brand-area">
                        <img src="<?= esc_url($footer_logo) ?>" alt="TUMO">
                        <p><?= $footer_paragraph; ?></p>
                    </div>
                    <div class="ti-footer-layout-1--social-area ti-footer-layout--social-area">
                ...
                <?php if ($footer_international_logo) : ?>
                    <div class="col-lg-2 order-3">
                        <div class="ti-footer-layout-<?= $layout ?>--company-area ti-footer-layout--company-area text-left">
        ...
        <div class="ti-footer-layout-1--bottom ti-footer-layout--bottom">
            <div class="row">
                <div class="col-sm-6 order-2 order-sm-1">
                    <p class="ti_copyright"><?= esc_html($footer_copyright); ?></p>
                </div>
                <div class="col-sm-6 order-1 order-sm-2 mb-1 mb-sm-0">
